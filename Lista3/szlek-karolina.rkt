...
(define (authenticate-and-decrypt cyphertext recipient-private-key sender-public-key)
  (let ({decrypted
    ...
    (if(= decrypted (compress (message cyphertext)))
...
(RSA-encrypt "qwertyu" (key-pair-public test-key-pair1))
(RSA-decrypt '(404051001 128404017) (key-pair-private test-key-pair1))
