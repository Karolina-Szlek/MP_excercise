...
(define y (mcons 1 (mcons 2 (mcons 3 (make-cycle (mcons 3 (mcons 3 (mcons 6 null))))))))|#
...
(define m-fact
  (lcons 1
         (lambda ()
           (lmap * m-fact (integers-starting-from 1)))));;lub  (lmap * fact (ltail (integers-starting-from 1))))))--
;żeby się 1 dwa razy nie pojawiało
